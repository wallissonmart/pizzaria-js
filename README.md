<h1 align="left">Site para pizzaria</h1>
<p align="left">Site para pizzaria fictícia com JavaScript puro</p>
...
Para acessar a página bastar clicar no seguinte link: https://wallissonmart.github.io/pizzaria-js/

<h1 align="left" id="funcionalidades">⚙️ Funcionalidades</h1>

- [x] Carrinho de compras;
- [x] Adição, edição e exclusão de produtos do carrinho;
- [x] Design responsivo;
